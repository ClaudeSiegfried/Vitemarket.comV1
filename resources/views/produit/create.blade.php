...
@section('content')
    ...
    <div class="container-fluid">
        <form method="post" action="{{ route('produit.store')}}"
            ...
            <div class="container-fluid border-left mb-0 col-md-12">
                <h4 class=" text-muted ml-5">Product {{ __('Create') }}<i
                        class="fas fa-angle-down ml-2"></i></h4>
            </div>

            <div class=" cols-sm-12 container-fluid">
                <div class="form">
                    <input class="form-control @error('Libele')
                               is-invalid @enderror" name="Libele" id="Libele"
                           value="{{old('Libele')}}" required
                    ...
                    <div class="col-md-6">
                        <div class="form ">
                            <input class="form-control py-4 @error('quantite_physique')
                                   ...
                                   id="quantite_physique" value="{{ old('quantite_physique') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form">
                            <input class="form-control py-4 @error('expiration_id')
                                   ...
                                   id="expiration_id" value="{{ old('expiration_id')}}"
            ...
            <div class="form-group mt-4 mb-0 pl-3">
                <button type="submit" class="btn btn-success btn-block rounded-pill shadow">
                    {{ __('Create new product') }}<i class="fas fa-angle-right ml-2"></i>
                </button>
            </div>
        </form>
    </div>
