...
@section('content')
    ...
    <form method="post" action="{{ route('categorie.store')}}"
        ...
        <div class="col-md-6 col-xs-12 p-5 h-100 border-left align-self-center">

            <h4 class="text-muted">Category {{ __('Create') }}<i
            ...
            <div class="form-group mt-5 mb-0">
                <button type="submit" class="btn btn-success btn-block rounded-pill shadow">
                    {{ __('Create a new category') }}<i class="fas fa-angle-right ml-2"></i>
                </button>
            </div>
